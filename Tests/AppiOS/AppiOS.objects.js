var saved_script_objects={
	"UIATableView": {
		...
		"version": 0,
		"object_type": "iOSTable",
		"object_flavor": "Table",
		"object_name": "UIATableView",
		"object_class": "",
		...
		"locations": [
			{
				...
				"location": {
					...
					"css": "",
					"id": "",
					"ios": "type == 'XCUIElementTypeTextField'"
				}
			}
		],
		"window_text": "Device",
		...
		"locations": [
			{
				"locator_name": "Mobile",
				"location": {
					"xpath": "//UIAApplication[1]/UIAWindow[1]/UIAToolbar[1]/UIAButton[1]",
					"css": "",
					"id": "",
					"ios": "UIATarget.localTarget().frontMostApp().mainWindow().toolbars()[0].buttons().withName('Contents')"
				}
			}
		],
		"window_text": "Device",
		...
		"locations": [
			{
				...
				"location": {
					...
					"css": "",
					"id": "",
					"ios": "UIATarget.localTarget().frontMostApp().mainWindow().tableViews()[0].cells()[2]"
				}
			}
		],
		"window_text": "Device",
	...
	"Switch": {
		...
		"object_role": "param:object_flavor",
		"version": 0,
		"object_type": "iOSSwitch",
		"object_flavor": "Switch",
		"object_name": "Switch",
		"ignore_object_name": true,
		"object_class": "",
		"object_library": "Mobile",
	...
	"Slider": {
		...
		"object_role": "param:object_flavor",
		"version": 0,
		"object_type": "iOSSlider",
		"object_flavor": "Slider",
		"object_name": "Slider",
		"ignore_object_name": true,
		"object_class": "",
		"object_library": "Mobile",
		...
		"locations": [
			{
				"locator_name": "Mobile",
				"location": {
					"xpath": "//UIAApplication[1]/UIAWindow[1]/UIAToolbar[1]/UIAButton[2]",
					"css": "",
					"id": "",
					"ios": "UIATarget.localTarget().frontMostApp().mainWindow().toolbars()[0].buttons()[1]",
					"acc": ""
				}
			}
		],
	...
	"PageIndicator": {
		...
		"object_role": "param:object_flavor",
		"version": 0,
		"object_type": "iOSPageIndicator",
		"object_flavor": "TabControl",
		"object_name": "PageIndicator",
		"ignore_object_name": true,
		"object_class": "",
		"object_library": "Mobile",
		"window_name": "Advanced"
	...
	"ScrollView": {
		...
		"object_role": "param:object_flavor",
		"version": 0,
		"object_type": "iOSScrollView",
		"object_flavor": "VScrollBar",
		"object_name": "VScrollBar",
		"ignore_object_name": true,
		"object_class": "",
		"object_library": "Mobile",
		"window_name": "Advanced"
		...
		"locations": [
			{
				...
				"location": {
					...
					"css": "",
					"id": "",
					"ios": "XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeScrollView/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther",
					"acc": ""
				}
			}
		],
	...
	"Mobile": {
		...
		"object_name": "Mobile",
		"ignore_object_name": true,
		"window_name": "WEBVIEW_1"
	},
	"Master_Minus_Detail_Table_View": {
		"locations": [
			{
				"locator_name": "Mobile",
				"location": {
					...
					"css": "",
					"id": "",
					"ios": "type == 'XCUIElementTypeTable'@@@XCUIElementTypeCell",
					"acc": ""
				}
			}
		],
		...
		"object_type": "iOSObject",
		"object_flavor": "Mobile",
		"object_name": "Master - Detail Table View",
		"object_class": "",
		"window_name": "Device",
		"ignore_object_name": true
	},
